              ...
              \begin{packed_item}
               \item  Web  preglednik
                ...
                \end{packed_item}
                 ...
                 \begin{figure}[H]
                     \includegraphics[width=10cm, height=8cm ]{./slike/arhitektura.png}
                      \centering
                  ...
                  \textit{Web aplikacija se najčešće dijeli na dva dijela: }
                		...
                		\item    \textbf{Back-end} koji je zadužen za obradu i spremanje podataka, koji dođu sa frontenda.
              		       ...
              		       \end{packed_item}
                                ...
                                MVC-ova karakteristika je dijeljenje aplikacije u više dijelova, koje pomažu u kontroliranju velikih količina podataka.
                               
                       \textbf{Prednosti MVC-a} :
                                 \begin{packed_item}
             			  \item  Lako održavanje i dodavanje novih funkcionalnosti u aplikaciju.
                		  \item  Testiranje aplikacije se obavlja lakse, jer se podijeljnja u više dijelova koji zajedno rade.
               		           \item  Brže razvijanje aplikacija,čak tri puta više s obzirom na ostale modele.
                    ...
                    \begin{figure}[H]
                     \includegraphics[width=10cm, height=8cm ]{./slike/mvc.jpg}
                      \centering
                      \caption{MVC model}
                    \end{figure}
